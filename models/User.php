...
class User {
     ...
     */
    public static function register ($name, $email,$telephone, $password) {
        ...
        $res->bindParam(':telephone', $telephone, PDO::PARAM_STR);
     ...
     * @return bool
     */
    public static function edit ($userId, $name, $telephone, $password){

        $db = Db::getConnection();

        $sql = "
               UPDATE user
                    SET name = :name,telephone=:telephone, password = :password
                      WHERE id = :id
               ";
